...
public APIResponse createPhieuXuat(@RequestBody PhieuXuatRequest request) {
    ...
    public List<PhieuXuat> getPhieuNhapByTrangThai(@PathVariable int trangthai) {
        return phieuXuatService.getPhieuXuatByTrangThai(trangthai);
    }
    @PutMapping("/updateStatus/{id}/{newStatus}")
    public Optional<PhieuXuat> updatePhieuXuatStatus(@PathVariable long id, @PathVariable int newStatus) {
        return phieuXuatService.updatePhieuXuatStatus(id, newStatus);
    }
